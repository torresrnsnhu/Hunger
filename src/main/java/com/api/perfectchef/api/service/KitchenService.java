package com.api.perfectchef.api.service;

import com.api.perfectchef.api.controller.ResultsResponse;
...
public class KitchenService {
    ...
    private ResponseEntity<List<RecipeDto>> convertToDto(List<Recipe> recipes) {
